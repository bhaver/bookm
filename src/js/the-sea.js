...
function register($form) {
    $.ajax({
        ...
        error: function(err) {
             $('#subscribe-notification').html('<span class="alert">Could not connect to the registration server. Please try again later.</span>');
            console.log('error:');
            console.log(err);
        },
        success: function(data) {
            ...
            if (data.result != "success") {
                $('#subscribe-notification').html('<span class="subscribeerror"> Error: ' + data.msg + '</span>');
            } else {
                $('#subscribe-notification').html('<span class="subscribesuccess"> Almost finished. Please click the link in the email we just sent you</span>');
